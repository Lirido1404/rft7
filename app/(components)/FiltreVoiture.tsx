  ...
  return (
    <>
      ...
      <div className="w-full mt-4 flex flex-col gap-1  " onClick={tagBmw}>
        ...
        <span className={`flex items-center justify-between hover:bg-[#F4F4F7] rounded-r-xl hover:gap-3 ease-in-out duration-150 cursor-pointer ${rechercheTag === "bmw" ? "bg-[#C91313] text-white" : ""}`}>
      ...
      <div className="w-full mt-4 flex flex-col gap-1 " onClick={tagMercedes}>
        <Separator className="w-[70%] bg-[#C91313] mx-auto" />
        <span className={`flex items-center justify-between hover:bg-[#F4F4F7] rounded-r-xl hover:gap-3 ease-in-out duration-150 cursor-pointer ${rechercheTag === "mercedes" ? "bg-[#C91313] text-white" : ""}`}>
      ...
      <div className="w-full mt-4 flex flex-col gap-1 " onClick={tagAudi}>
        <Separator className="w-[70%] bg-[#C91313] mx-auto" />
        <span className={`flex items-center justify-between hover:bg-[#F4F4F7] rounded-r-xl hover:gap-3 ease-in-out duration-150 cursor-pointer ${rechercheTag === "audi" ? "bg-[#C91313] text-white" : ""}`}>
