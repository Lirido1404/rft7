 ...
 const ppUser = session?.user?.image;
  return (
    <div className="h-[80vh] flex flex-col justify-center relative">
              <div className="blob3 absolute top-20 right-20 opacity-70 w-[130px] h-[130px] lg:w-[400px] lg:h-[400px] "></div>

      <Drawer>
        <div className="flex flex-col gap-2 pl-16">
          <h2 className="font-bold lg:text-5xl text-xl">Dates de rassemblements</h2>
        ...
        <div className="blob2 absolute -bottom-40 -left-12 opacity-70 w-10 h-10 lg:w-80 lg:h-80 "></div>
